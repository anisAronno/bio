  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
    <switch>
      <g>
        ...
        <path
          fill="url(#a)"
          d="m174.2 168.2-9.8-2.6c-10.5-1.5-17.2 6.6-14.9 20.2 2 12.3 5.9 22.8 11.2 37.3 6 16.4 18.1 13.1 18.1 13.1l-4.6-68z"
        />
        <linearGradient
          id="b"
          x1="338.165"
        ...
        <path
          fill="url(#b)"
          d="m327.7 168.2 9.8-2.6c10.4-1.5 17.2 6.6 14.9 20.2-2 12.3-5.9 22.8-11.2 37.3-6 16.4-18.1 13.1-18.1 13.1l4.6-68z"
        />
        <linearGradient
          id="c"
          x1="250.291"
        ...
        <path
          fill="url(#c)"
          d="m487.4 530.8-15.9-97.6c-5.6-27.8-28.5-49.8-57.7-55.2l-93.5-29.3c-9.3-1.4-16.6-11-16.7-21l-2.3-46.2H200l-2.4 48.1c-.5 9.4-7.5 17.2-16.8 18.7L87.6 381c-29.2 5.4-52.1 27.3-57.7 55.2l-16.8 94c59.5-.1 414.5.6 474.3.6z"
        />
        <linearGradient
          id="d"
          x1="251.616"
        ...
        <path
          fill="url(#d)"
          d="m251.3 95-10.6.1c-38.7.2-70 31.6-70 70.3v83.5c0 10.4 4 20.4 11.2 27.9l24.8 25.8c7.2 7.4 17.1 11.7 27.4 11.7h35.1c10.3 0 20.3-4.2 27.4-11.7l24.8-25.8c7.2-7.5 11.2-17.5 11.2-27.9v-83.5c0-38.7-31.3-70.2-70-70.3l-11.3-.1z"
        />
        <path
          fill="#fff"
          d="m417.4 379-96.2-30.2c-6.5 15.5-23.6 37.7-67.7 37.7-45.9 0-60.5-25.3-65.1-41.2-2.3 1.5-4.8 2.5-7.6 3l-98.2 31.3c-29.2 5.4-52.1 27.3-57.7 55.2l-11.7 95.5h295.4c82.8 0 153.8.5 178.1.5l-11.6-96.6c-5.6-27.9-28.5-49.8-57.7-55.2z"
        />
        <linearGradient
          id="e"
          x1="376.935"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset=".005" stop-color="#000014" />
          <stop offset="1" stop-color="#0B50A5" />
        </linearGradient>
        <path
          fill="url(#e)"
          d="m489.3 555.4-8.8-126.7c-5.6-27.8-28.5-49.8-57.7-55.2l-116-34.2c-4.2 5.4-42.1 290.2-42.2 291.3"
        />
        <linearGradient
          id="f"
          x1="114.859"
        ...
        <path
          fill="url(#f)"
          d="M219 638.2S196.6 340 193.8 340.4c0 0-84 29.8-112.8 37.2-28.7 7.4-52.1 27.4-57.6 55.2L10.7 554.4"
        />
        <path
          fill="#231f20"
          d="M264.3 304.6h-24.5c-2.1 0-3.5-2.3-2.4-4.2l3.6-6.2c.5-.9 1.4-1.4 2.4-1.4h17.4c1 0 1.9.5 2.4 1.4l3.6 6.2c1 1.8-.3 4.2-2.5 4.2z"
        />
        <linearGradient
          id="g"
          x1="205.795"
        ...
        <path
          fill="url(#g)"
          d="M194.5 340s2.8 28.2 3.6 37.5c1.8 19.7 6.7 78.8 6.7 78.8l-13.4-49.5-23.8 27.8 7.8-87.6 19.1-7z"
        />
        <linearGradient
          id="h"
          x1="285.559"
        ...
        <path
          fill="url(#h)"
          d="M306.8 338.9S302 354 299.7 375c-2.3 20.5-11.4 81.8-11.4 81.8l15.6-46.3 22.5 26.4.2-91.8-19.8-6.2z"
        />
        <linearGradient
          id="i"
          x1="254.835"
