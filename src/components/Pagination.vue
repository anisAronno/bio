<template>
  <nav aria-label="pagination" class="my-10 flex justify-center">
    <ul class="inline-flex -space-x-px">
      ...
      <li
        :class="[
          pagination.current_page === 1 ? 'pagination-active font-bolder text-xl' : '',
      ...
      <li
        ...
        :class="[isCurrentPage(page) ? 'pagination-active' : '', 'pagination-link']"
      >
        <a>{{ page }} </a>
      </li>
      ...
      <li
        :class="[
          pagination.current_page === pagination.last_page ? 'pagination-active font-bolder' : '',
          'pagination-link  text-xl'
        ]"
      >
        <a @click.prevent="changePage(pagination.current_page + 1)">{{ '>' }}</a>
      </li>
      <li
        :class="[
          pagination.current_page === pagination.last_page ? 'pagination-active font-bolder' : '',
